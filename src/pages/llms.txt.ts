...
export const GET: APIRoute = () => {
  ...
  const lines = [
    "# tannerwj.com",
    "",
    "> Personal site of Tanner Johnson — principal engineer in Utah.",
    "> Focused on large-scale security, architecture, and AI orchestration.",
    "",
    "## About",
    "",
    "Tanner Johnson is a principal engineer in Utah focused on large-scale",
    "security, architecture, and AI orchestration. Side projects — apps,",
    "trading toys, games, comics, star charts — go from idea to live URL fast.",
    "",
